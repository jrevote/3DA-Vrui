...
METHODPREFIX AffineTransformation<ScalarParam,dimensionParam>::AffineTransformation(const TranslationTransformation<SourceScalarParam,dimensionParam>& source)
	:matrix(Scalar(1))
	{
...
template <class ScalarParam,int dimensionParam>
template <class SourceScalarParam>
METHODPREFIX AffineTransformation<ScalarParam,dimensionParam>::AffineTransformation(const RotationTransformation<SourceScalarParam,dimensionParam>& source)
	:matrix(Scalar(1))
	{
	source.writeMatrix(matrix);
	}
...
template <class ScalarParam,int dimensionParam>
template <class SourceScalarParam>
METHODPREFIX AffineTransformation<ScalarParam,dimensionParam>::AffineTransformation(const OrthonormalTransformation<SourceScalarParam,dimensionParam>& source)
	:matrix(Scalar(1))
	{
	source.writeMatrix(matrix);
	}
...
template <class ScalarParam,int dimensionParam>
template <class SourceScalarParam>
METHODPREFIX AffineTransformation<ScalarParam,dimensionParam>::AffineTransformation(const UniformScalingTransformation<SourceScalarParam,dimensionParam>& source)
	:matrix(Scalar(1))
	{
	source.writeMatrix(matrix);
	}
...
template <class ScalarParam,int dimensionParam>
template <class SourceScalarParam>
METHODPREFIX AffineTransformation<ScalarParam,dimensionParam>::AffineTransformation(const OrthogonalTransformation<SourceScalarParam,dimensionParam>& source)
	:matrix(Scalar(1))
	{
	source.writeMatrix(matrix);
	}
...
template <class ScalarParam,int dimensionParam>
template <class SourceScalarParam>
METHODPREFIX AffineTransformation<ScalarParam,dimensionParam>::AffineTransformation(const ScalingTransformation<SourceScalarParam,dimensionParam>& source)
	:matrix(Scalar(1))
	{
	source.writeMatrix(matrix);
	}
...
template <class ScalarParam,int dimensionParam>
METHODPREFIX AffineTransformation<ScalarParam,dimensionParam>& AffineTransformation<ScalarParam,dimensionParam>::operator*=(const AffineTransformation<ScalarParam,dimensionParam>& other)
	{
...
template <class ScalarParam,int dimensionParam>
METHODPREFIX AffineTransformation<ScalarParam,dimensionParam>& AffineTransformation<ScalarParam,dimensionParam>::leftMultiply(const AffineTransformation<ScalarParam,dimensionParam>& other)
	{
	Scalar temp[dimension][dimension+1];
	for(int i=0;i<dimension;++i)
		{
...
template <class ScalarParam,int dimensionParam>
METHODPREFIX AffineTransformation<ScalarParam,dimensionParam> operator*(const AffineTransformation<ScalarParam,dimensionParam>& t1,const AffineTransformation<ScalarParam,dimensionParam>& t2)
	{
...
template <class ScalarParam,int dimensionParam>
METHODPREFIX AffineTransformation<ScalarParam,dimensionParam>& AffineTransformation<ScalarParam,dimensionParam>::doInvert(void)
	{
...
template <class ScalarParam,int dimensionParam>
METHODPREFIX AffineTransformation<ScalarParam,dimensionParam> invert(const AffineTransformation<ScalarParam,dimensionParam>& t)
	{
