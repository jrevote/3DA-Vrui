...
class SplinePatch
	...
	typedef Vector<ScalarParam,dimensionParam> Vector;
	typedef Point<ScalarParam,dimensionParam> Point;
	typedef ComponentArray<int,2> Size; // Type for array sizes and such
	typedef ComponentArray<int,2> Index; // Type for indices in control point and knot arrays
	typedef ComponentArray<ScalarParam,2> Parameter; // Type for spline patch parameters
