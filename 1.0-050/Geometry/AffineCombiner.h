...
class AffineCombiner
	...
	typedef ComponentArray<ScalarParam,dimensionParam> PointSum; // Type for sums of points
	typedef Point<ScalarParam,dimensionParam> Point; // Type of created/used points
