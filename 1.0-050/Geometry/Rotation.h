...
class Rotation<ScalarParam,2>
	...
	typedef Vector<ScalarParam,2> Vector; // Compatible vector type
	typedef Point<ScalarParam,2> Point; // Compatible point type
	typedef HVector<ScalarParam,2> HVector; // Compatible homogenuous vector type
...
class Rotation<ScalarParam,3>
	...
	typedef Vector<ScalarParam,3> Vector; // Compatible vector type
	typedef Point<ScalarParam,3> Point; // Compatible point type
	typedef HVector<ScalarParam,3> HVector; // Compatible homogenuous vector type
