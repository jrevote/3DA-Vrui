...
class PointKdTree
	...
	typedef Point<ScalarParam,dimensionParam> Point; // Type for positions
	typedef ClosePointSet<StoredPointParam> ClosePointSet; // Type for nearest neighbours query results
