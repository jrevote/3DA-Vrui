...
class AffineTransformationOperations
	...
	/* Embedded classes: */
	public:
	typedef Matrix<ScalarParam,dimensionParam,dimensionParam+1> M;
	typedef Vector<ScalarParam,dimensionParam> V;
	typedef Point<ScalarParam,dimensionParam> P;
	typedef HVector<ScalarParam,dimensionParam> HV;
...
class AffineTransformationOperations<ScalarParam,2>
	...
	/* Embedded classes: */
	public:
	typedef Matrix<ScalarParam,2,3> M;
	typedef Vector<ScalarParam,2> V;
	typedef Point<ScalarParam,2> P;
	typedef HVector<ScalarParam,2> HV;
...
class AffineTransformationOperations<ScalarParam,3>
	...
	/* Embedded classes: */
	public:
	typedef Matrix<ScalarParam,3,4> M;
	typedef Vector<ScalarParam,3> V;
	typedef Point<ScalarParam,3> P;
	typedef HVector<ScalarParam,3> HV;
...
class AffineTransformation // Class for affine transformations
	...
	typedef Point<ScalarParam,dimensionParam> Point; // Compatible point type
	typedef HVector<ScalarParam,dimensionParam> HVector; // Compatible homogenuous vector type
	typedef Rotation<ScalarParam,dimensionParam> Rotation; // Compatible rotation type
	typedef ComponentArray<ScalarParam,dimensionParam> Scale; // Type for scale factors
	typedef Matrix<ScalarParam,dimensionParam,dimensionParam+1> Matrix; // Compatible matrix type
	private:
