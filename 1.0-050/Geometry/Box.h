...
class Box
	...
	typedef Point<ScalarParam,dimensionParam> Point; // The type for points
	typedef Vector<ScalarParam,dimensionParam> Vector; // The type for vectors
	typedef ComponentArray<ScalarParam,dimensionParam> Size; // The type for size values
	typedef Ray<ScalarParam,dimensionParam> Ray; // Compatible ray type
