...
class HIDDevice:public VRDevice
	...
	/* Embedded classes: */
	private:
	struct AxisConverter // Structure to convert raw axis values to the [-1, 1] range
		{
		/* Elements: */
		public:
		float negMin,negMax,negRange;
		float posMin,posMax,posRange;
