...
Scalar getInchFactor(void); // Returns the length of an inch, expressed in physical units
...
double getCurrentFrameTime(void); // Returns the current time between frames (1/framerate) in seconds
