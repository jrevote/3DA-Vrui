...
MeasurementToolFactory::MeasurementToolFactory(ToolManager& toolManager)
	:ToolFactory("MeasurementTool",toolManager),
	 ...
	 defaultCoordinateMode(NAVIGATIONAL),
...
MeasurementTool::MeasurementTool(const ToolFactory* sFactory,const ToolInputAssignment& inputAssignment)
	...
	GLMotif::RadioBox* coordinateModes=new GLMotif::RadioBox("CoordinateModes",modeBox,false);
	...
	dist[0]=new GLMotif::TextField("Dist1",measurementBox,16);
	...
	dist[1]=new GLMotif::TextField("Dist2",measurementBox,16);
	dist[1]->setPrecision(10);
	
	new GLMotif::Label("AngleLabel",measurementBox,"Angle");
	
	angle=new GLMotif::TextField("Angle",measurementBox,16);
			...
			if(factory->measurementFile!=0)
				...
				switch(measurementMode)
					...
					case MeasurementToolFactory::POSITION:
						...
						fprintf(factory->measurementFile->getFilePtr()," (%12.6g, %12.6g, %12.6g)\n",points[0][0],points[0][1],points[0][2]);
						break;
					
					case MeasurementToolFactory::DISTANCE:
						fprintf(factory->measurementFile->getFilePtr()," distance");
						fprintf(factory->measurementFile->getFilePtr()," (%12.6g, %12.6g, %12.6g)",points[0][0],points[0][1],points[0][2]);
						fprintf(factory->measurementFile->getFilePtr()," (%12.6g, %12.6g, %12.6g)",points[1][0],points[1][1],points[1][2]);
					...
					case MeasurementToolFactory::ANGLE:
						...
						fprintf(factory->measurementFile->getFilePtr()," (%12.6g, %12.6g, %12.6g)",points[2][0],points[2][1],points[2][2]);
