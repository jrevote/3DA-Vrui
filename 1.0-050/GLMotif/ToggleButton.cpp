...
ZRange ToggleButton::calcZRange(void) const
	...
	if(zRange.first>-getBorderWidth()-toggleBorderWidth)
		zRange.first=-getBorderWidth()-toggleBorderWidth;
	if(zRange.second<getBorderWidth()+toggleBorderWidth)
		zRange.second=getBorderWidth()+toggleBorderWidth;
