...
ZRange Slider::calcZRange(void) const
	...
	GLfloat sliderMin2=getInterior().origin[2]-shaftDepth;
	if(myZRange.first>sliderMin2)
		myZRange.first=sliderMin2;
	GLfloat sliderMax2=getInterior().origin[2]+sliderHeight;
	if(myZRange.second<sliderMax2)
		myZRange.second=sliderMax2;
