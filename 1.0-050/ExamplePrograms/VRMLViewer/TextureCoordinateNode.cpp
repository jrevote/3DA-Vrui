/***********************************************************************
TextureTextureCoordinateNode - Class for arrays of vertex texture coordinates.
	...
	while(!parser.isToken("}"))
		...
		if(parser.isToken("point"))
			...
			while(!parser.isToken("]"))
				...
				for(int i=0;i<2&&!parser.isToken(",")&&!parser.isToken("]");++i)
					{
...
void TextureCoordinateNode::glRenderAction(GLContextData& contextData) const
	{
	}
