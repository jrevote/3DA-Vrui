...
class VRMLParser
	...
	/* Embedded classes: */
	private:
	typedef Misc::HashTable<NodeName,Pointer<VRMLNode>,NodeName> NodeDictionary; // Type to look up nodes by name
	...
	Pointer<VRMLNode> getNextNode(void); // Returns the next VRML node parsed from the input file
	};
