...
GLMotif::PopupWindow* ShowEarthModel::createRenderDialog(void)
	...
	GLMotif::RowColumn* surfaceSettings=new GLMotif::RowColumn("SurfaceSettings",renderDialog,false);
	
	GLMotif::ToggleButton* showSurfaceToggle=new GLMotif::ToggleButton("ShowSurfaceToggle",surfaceSettings,"Show Surface");
	...
	GLMotif::RowColumn* surfaceTransparencies=new GLMotif::RowColumn("Transparencies",surfaceSettings,false);
	surfaceTransparencies->setNumMinorWidgets(2);
	
	GLMotif::Label* surfaceTransparencyLabel=new GLMotif::Label("SurfaceTransparencyLabel",surfaceTransparencies,"Surface Transparency");
	surfaceTransparencyLabel->setHAlignment(GLFont::Left);
	GLMotif::Slider* surfaceTransparencySlider=new GLMotif::Slider("SurfaceTransparencySlider",surfaceTransparencies,GLMotif::Slider::HORIZONTAL,ss.fontHeight*5.0f);
	...
	GLMotif::Label* gridTransparencyLabel=new GLMotif::Label("GridTransparencyLabel",surfaceTransparencies,"Grid Transparency");
	gridTransparencyLabel->setHAlignment(GLFont::Left);
	GLMotif::Slider* gridTransparencySlider=new GLMotif::Slider("GridTransparencySlider",surfaceTransparencies,GLMotif::Slider::HORIZONTAL,ss.fontHeight*5.0f);
	...
	surfaceTransparencies->manageChild();
	
	surfaceSettings->manageChild();
	
	GLMotif::RowColumn* outerCoreSettings=new GLMotif::RowColumn("OuterCoreSettings",renderDialog,false);
	
	GLMotif::ToggleButton* showOuterCoreToggle=new GLMotif::ToggleButton("ShowOuterCoreToggle",outerCoreSettings,"Show Outer Core");
	...
	GLMotif::RowColumn* outerCoreTransparencies=new GLMotif::RowColumn("Transparencies",outerCoreSettings,false);
	outerCoreTransparencies->setNumMinorWidgets(2);
	
	GLMotif::Label* outerCoreTransparencyLabel=new GLMotif::Label("OuterCoreTransparencyLabel",outerCoreTransparencies,"Outer Core Transparency");
	outerCoreTransparencyLabel->setHAlignment(GLFont::Left);
	GLMotif::Slider* outerCoreTransparencySlider=new GLMotif::Slider("OuterCoreTransparencySlider",outerCoreTransparencies,GLMotif::Slider::HORIZONTAL,ss.fontHeight*5.0f);
	...
	outerCoreTransparencies->manageChild();
	
	outerCoreSettings->manageChild();
	
	GLMotif::RowColumn* innerCoreSettings=new GLMotif::RowColumn("InnerCoreSettings",renderDialog,false);
	
	GLMotif::ToggleButton* showInnerCoreToggle=new GLMotif::ToggleButton("ShowInnerCoreToggle",innerCoreSettings,"Show Inner Core");
	...
	GLMotif::RowColumn* innerCoreTransparencies=new GLMotif::RowColumn("Transparencies",innerCoreSettings,false);
	innerCoreTransparencies->setNumMinorWidgets(2);
	
	GLMotif::Label* innerCoreTransparencyLabel=new GLMotif::Label("InnerCoreTransparencyLabel",innerCoreTransparencies,"Inner Core Transparency");
	innerCoreTransparencyLabel->setHAlignment(GLFont::Left);
	GLMotif::Slider* innerCoreTransparencySlider=new GLMotif::Slider("InnerCoreTransparencySlider",innerCoreTransparencies,GLMotif::Slider::HORIZONTAL,ss.fontHeight*5.0f);
	...
	innerCoreTransparencies->manageChild();
	
	innerCoreSettings->manageChild();
	
	GLMotif::RowColumn* earthquakePointSizes=new GLMotif::RowColumn("EarthquakePointSize",renderDialog,false);
	earthquakePointSizes->setNumMinorWidgets(2);
	
	GLMotif::Label* earthquakePointSizeLabel=new GLMotif::Label("EarthquakePointSizeLabel",earthquakePointSizes,"Earthquake Point Size");
	earthquakePointSizeLabel->setHAlignment(GLFont::Left);
	GLMotif::Slider* earthquakePointSizeSlider=new GLMotif::Slider("EarthquakePointSizeSlider",earthquakePointSizes,GLMotif::Slider::HORIZONTAL,ss.fontHeight*5.0f);
	...
	earthquakePointSizes->manageChild();
