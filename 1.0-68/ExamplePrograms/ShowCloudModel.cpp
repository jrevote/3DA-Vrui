/***********************************************************************
ShowCloudModel - Simple Vrui application to render a model of Earth,
...
#include "ShowCloudModel.h"

/*******************************************************************
Methods of class ShowCloudModel::RotatedGeodeticCoordinateTransform:
*******************************************************************/

ShowCloudModel::RotatedGeodeticCoordinateTransform::RotatedGeodeticCoordinateTransform(void)
   :Vrui::GeodeticCoordinateTransform(0.001),
    rotationAngle(0),raSin(0),raCos(1)
   {
   }

const char* ShowCloudModel::RotatedGeodeticCoordinateTransform::getUnitName(int componentIndex) const
   {
...
const char* ShowCloudModel::RotatedGeodeticCoordinateTransform::getUnitAbbreviation(int componentIndex) const
   {
   switch(componentIndex)
      {
      case 0:
...
Vrui::Point ShowCloudModel::RotatedGeodeticCoordinateTransform::transform(const Vrui::Point& navigationPoint) const
   {
...
void ShowCloudModel::RotatedGeodeticCoordinateTransform::setRotationAngle(Vrui::Scalar newRotationAngle)
   {
...
/*****************************************
Methods of class ShowCloudModel::DataItem:
*****************************************/

ShowCloudModel::DataItem::DataItem(void)
...
/********************************************
Methods of class ShowCloudModel::BaseLocator:
********************************************/

ShowCloudModel::BaseLocator::BaseLocator(Vrui::LocatorTool* sLocatorTool,ShowCloudModel* sApplication)
   :Vrui::LocatorToolAdapter(sLocatorTool),
    application(sApplication)
   {
   }

void ShowCloudModel::BaseLocator::glRenderAction(GLContextData& contextData) const
   {
   }

/********************************************
Methods of class ShowCloudModel::DataLocator:
********************************************/

ShowCloudModel::DataLocator::DataLocator(Vrui::LocatorTool* sLocatorTool,ShowCloudModel* sApplication)
   ...
   setTimeButton->getSelectCallbacks().add(this,&ShowCloudModel::DataLocator::setTimeButtonSelectCallback);
...
ShowCloudModel::DataLocator::~DataLocator(void)
   {
...
void ShowCloudModel::DataLocator::buttonPressCallback(Vrui::LocatorTool::ButtonPressCallbackData* cbData)
   {
...
void ShowCloudModel::DataLocator::glRenderAction(GLContextData& contextData) const
   {
   if(selectedEvent!=0)
      {
...
void ShowCloudModel::DataLocator::setTimeButtonSelectCallback(Misc::CallbackData* cbData)
   {
   if(selectedEvent!=0)
      {
...
/*******************************
Methods of class ShowCloudModel:
*******************************/

GLMotif::Popup* ShowCloudModel::createRenderTogglesMenu(void)
   {
   ...
   showSurfaceToggle->getValueChangedCallbacks().add(this,&ShowCloudModel::menuToggleSelectCallback);
   ...
   surfaceTransparentToggle->getValueChangedCallbacks().add(this,&ShowCloudModel::menuToggleSelectCallback);
   ...
   showGridToggle->getValueChangedCallbacks().add(this,&ShowCloudModel::menuToggleSelectCallback);
   ...
   for(unsigned int i=0;i<earthquakeSets.size();++i)
      ...
      char toggleName[256];
      snprintf(toggleName,sizeof(toggleName),"ShowCloudquakeSetToggle%04d",i);
      ...
      showEarthquakeSetToggle->getValueChangedCallbacks().add(this,&ShowCloudModel::menuToggleSelectCallback);
      }
   ...
   for(unsigned int i=0;i<pointSets.size();++i)
      ...
      showPointSetToggle->getValueChangedCallbacks().add(this,&ShowCloudModel::menuToggleSelectCallback);
      }
   ...
   if(seismicPaths.size()>0)
      ...
      showSeismicPathsToggle->getValueChangedCallbacks().add(this,&ShowCloudModel::menuToggleSelectCallback);
      }
   ...
   showOuterCoreToggle->getValueChangedCallbacks().add(this,&ShowCloudModel::menuToggleSelectCallback);
   ...
   outerCoreTransparentToggle->getValueChangedCallbacks().add(this,&ShowCloudModel::menuToggleSelectCallback);
   ...
   showInnerCoreToggle->getValueChangedCallbacks().add(this,&ShowCloudModel::menuToggleSelectCallback);
   ...
   innerCoreTransparentToggle->getValueChangedCallbacks().add(this,&ShowCloudModel::menuToggleSelectCallback);
...
GLMotif::PopupMenu* ShowCloudModel::createMainMenu(void)
   {
   ...
   rotateEarthToggle->getValueChangedCallbacks().add(this,&ShowCloudModel::menuToggleSelectCallback);
   ...
   lockToSphereToggle->getValueChangedCallbacks().add(this,&ShowCloudModel::menuToggleSelectCallback);
   ...
   centerDisplayButton->getSelectCallbacks().add(this,&ShowCloudModel::centerDisplayCallback);
   ...
   showRenderDialogToggle->getValueChangedCallbacks().add(this,&ShowCloudModel::menuToggleSelectCallback);
   ...
   showAnimationDialogToggle->getValueChangedCallbacks().add(this,&ShowCloudModel::menuToggleSelectCallback);
...
GLMotif::PopupWindow* ShowCloudModel::createRenderDialog(void)
   {
   const GLMotif::StyleSheet& ss=*Vrui::getWidgetManager()->getStyleSheet();
   ...
   surfaceTransparencySlider->getValueChangedCallbacks().add(this,&ShowCloudModel::sliderCallback);
   ...
   gridTransparencySlider->getValueChangedCallbacks().add(this,&ShowCloudModel::sliderCallback);
   ...
   outerCoreTransparencySlider->getValueChangedCallbacks().add(this,&ShowCloudModel::sliderCallback);
   ...
   innerCoreTransparencySlider->getValueChangedCallbacks().add(this,&ShowCloudModel::sliderCallback);
   ...
   earthquakePointSizeSlider->getValueChangedCallbacks().add(this,&ShowCloudModel::sliderCallback);
...
void ShowCloudModel::updateCurrentTime(void)
   {
...
GLMotif::PopupWindow* ShowCloudModel::createAnimationDialog(void)
   {
   const GLMotif::StyleSheet& ss=*Vrui::getWidgetManager()->getStyleSheet();
   ...
   currentTimeSlider->getValueChangedCallbacks().add(this,&ShowCloudModel::sliderCallback);
   ...
   playSpeedSlider->getValueChangedCallbacks().add(this,&ShowCloudModel::sliderCallback);
   
   playToggle=new GLMotif::ToggleButton("PlayToggle",animationDialog,"Playback");
   playToggle->setToggle(play);
   playToggle->getValueChangedCallbacks().add(this,&ShowCloudModel::menuToggleSelectCallback);
...
GLPolylineTube* ShowCloudModel::readSensorPathFile(const char* sensorPathFileName,double scaleFactor)
   {
   /* Open the file: */
   ...
   while(true)
      ...
      if(strncmp(line,"PROF_ID=",8)==0) // This line contains number of samples
         ...
         if(sscanf(line+8,"%u",&numSamples)!=1)
            Misc::throwStdErr("ShowCloudModel::readSensorPathFile: Unable to parse number of samples in sensor path file %s",sensorPathFileName);
         }
   ...
   for(unsigned int i=0;i<numSamples;++i)
      ...
      if(sscanf(line,"%f %f %f %f",&lon,&lat,&depth,&value)!=4)
         Misc::throwStdErr("ShowCloudModel::readSensorPathFile: Error while reading sensor path file %s",sensorPathFileName);
...
ShowCloudModel::ShowCloudModel(int& argc,char**& argv,char**& appDefaults)
...
ShowCloudModel::~ShowCloudModel(void)
   {
...
void ShowCloudModel::initContext(GLContextData& contextData) const
   {
   ...
   glBegin(GL_POLYGON);
      ...
      glVertex3f( 0.00000f, 100.00000f, 0.00000f );
      glVertex3f( 0.00000f, 200.00000f, 0.00000f );
      glVertex3f( 100.00000f, 0.00000f, 0.00000f );
      glVertex3f( 100.00000f, 100.00000f, 0.00000f );
      glVertex3f( 100.00000f, 200.00000f, 0.00000f );
      glVertex3f( 200.00000f, 0.00000f, 0.00000f );
      glVertex3f( 200.00000f, 100.00000f, 0.00000f );
      glVertex3f( 200.00000f, 200.00000f, 0.00000f );
      glVertex3f( 0.00000f, 0.00000f, 100.00000f );
      glVertex3f( 0.00000f, 100.00000f, 100.00000f );
      glVertex3f( 0.00000f, 200.00000f, 100.00000f );
      glVertex3f( 100.00000f, 0.00000f, 100.00000f );
      glVertex3f( 100.00000f, 100.00000f, 100.00000f );
      glVertex3f( 100.00000f, 200.00000f, 100.00000f );
      glVertex3f( 200.00000f, 0.00000f, 100.00000f );
      glVertex3f( 200.00000f, 100.00000f, 100.00000f );
      glVertex3f( 200.00000f, 200.00000f, 100.00000f );
      glVertex3f( 0.00000f, 0.00000f, 200.00000f );
      glVertex3f( 0.00000f, 100.00000f, 200.00000f );
      glVertex3f( 0.00000f, 200.00000f, 200.00000f );
      glVertex3f( 100.00000f, 0.00000f, 200.00000f );
      glVertex3f( 100.00000f, 100.00000f, 200.00000f );
      glVertex3f( 100.00000f, 200.00000f, 200.00000f );
      glVertex3f( 200.00000f, 0.00000f, 200.00000f );
      glVertex3f( 200.00000f, 100.00000f, 200.00000f );
      glVertex3f( 200.00000f, 200.00000f, 200.00000f );
   glEnd();
   glEndList();

   }

void ShowCloudModel::toolCreationCallback(Vrui::ToolManager::ToolCreationCallbackData* cbData)
   {
   ...
   if(surfaceNavigationTool!=0)
      ...
      surfaceNavigationTool->setAlignFunction(Misc::createFunctionCall<Vrui::NavTransform&,ShowCloudModel>(this,&ShowCloudModel::alignSurfaceFrame));
      }
   }

void ShowCloudModel::toolDestructionCallback(Vrui::ToolManager::ToolDestructionCallbackData* cbData)
   {
...
void ShowCloudModel::frame(void)
   {
...
void ShowCloudModel::display(GLContextData& contextData) const
   {
   #if 0
...
void ShowCloudModel::alignSurfaceFrame(Vrui::NavTransform& surfaceFrame)
   {
   /* Create a geoid: */
...
void ShowCloudModel::menuToggleSelectCallback(GLMotif::ToggleButton::ValueChangedCallbackData* cbData)
   {
   ...
   if(strcmp(cbData->toggle->getName(),"ShowSurfaceToggle")==0)
      ...
      showGrid=cbData->set;
   else if(strncmp(cbData->toggle->getName(),"ShowCloudquakeSetToggle",23)==0)
      {
...
void ShowCloudModel::sliderCallback(GLMotif::Slider::ValueChangedCallbackData* cbData)
   {
...
void ShowCloudModel::centerDisplayCallback(Misc::CallbackData* cbData)
   {
...
int main(int argc,char* argv[])
   ...
   try
      ...
      char** appDefaults=0;
      ShowCloudModel app(argc,argv,appDefaults);
