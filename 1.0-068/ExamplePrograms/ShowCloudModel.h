...
class ShowCloudModel:public Vrui::Application,public GLObject
	{
	/* Embedded classes: */
	private:
	...
	class BaseLocator:public Vrui::LocatorToolAdapter // Base class for locators
		...
		/* Elements: */
		protected:
		ShowCloudModel* application;
		
		/* Constructors and destructors: */
		public:
		BaseLocator(Vrui::LocatorTool* sTool,ShowCloudModel* sApplication);
	...
	class DataLocator:public BaseLocator
		...
		/* Constructors and destructors: */
		public:
		DataLocator(Vrui::LocatorTool* sTool,ShowCloudModel* sApplication);
	...
	/* Constructors and destructors: */
	public:
	ShowCloudModel(int& argc,char**& argv,char**& appDefaults);
	virtual ~ShowCloudModel(void);
